...
class Search {
  ...
  constructor() {
    ...
    this.openSearch = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-search-trigger');
  ...
  event() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.dispatchKeyPress.bind(this));
