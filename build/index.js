...
const likeBox = new _modules_Like__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
class MyNotes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.update-note').on("click", this.updateNote);
  }
  // Hàm sửa ghi chú 
  editNote(e) {
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityData.root_url + "/wp-json/university/v1/universities?term=" + this.searchField.value);
